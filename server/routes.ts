  ...
  router.get('/api/radar', async (req, res) => {
    try {
      ...
      const results = [
        ...
        { id: 'old_backlog', title: 'Backlog envelhecido', icon: '🔴', subtitle: '> 30 dias', level: 'critical', count: alerts.old_backlog.length, trend: calcTrend(alerts.old_backlog), tickets: alerts.old_backlog },
